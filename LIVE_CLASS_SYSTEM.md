...
Teachers can save questions for reuse:
...
│  4 opts • 30s                       │
│  ─────────────────────────────────  │
│  Capital of France?  [EDIT] [▶] [✕] │
│  3 opts • 20s • 🖼️                  │
│  ─────────────────────────────────  │
│  [💾 SAVE TO BANK] [🚀 START NOW]   │
└─────────────────────────────────────┘
```

### Image Support

Quiz questions can include images:

```typescript
const quiz = {
  id: "quiz-123",
  question: "What animal is shown?",
  image: "https://example.com/cat.jpg", // Optional image URL
