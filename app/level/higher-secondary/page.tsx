...
import { ArrowLeft, Crown, Brain } from "lucide-react"
            ...
            {grades.map((grade, index) => (
              ...
              >
                <Link href={grade.href}>
                  <Card className="group relative overflow-hidden border-zinc-200 dark:border-zinc-800 hover:border-purple-500 dark:hover:border-purple-400 transition-all duration-300 cursor-pointer h-32 md:h-40 bg-gradient-to-br from-white to-zinc-100 dark:from-zinc-900 dark:to-black shadow-lg hover:shadow-xl">
                    ...
                    <div className="relative p-4 md:p-6 text-center h-full flex flex-col justify-center">
                      ...
                      <div className={`w-10 h-10 md:w-12 md:h-12 rounded-lg bg-gradient-to-br ${
                        grade.color === 'teal' ? 'from-teal-500 to-teal-700 dark:from-teal-400 dark:to-teal-600' :
