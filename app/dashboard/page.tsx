        ...
        if (dashboardData.progress && dashboardData.progress.length > 0) {
          ...
          const realAchievements: Achievement[] =
            dashboardData.achievements.map((a) => ({
              ...
              earnedDate: new Date(a.earned_at || a.earned_date).toISOString().split("T")[0],
                                  ...
                                  <div className="space-y-1.5">
                                    {achievements
                                      ...
                                      .map((achievement, index) => (
                                        <div
                                          key={achievement.id}
                                          className="p-2 bg-gradient-to-r from-yellow-900/20 to-orange-900/20 rounded border border-yellow-600/30"
                                        >
                                          <div className="flex items-center gap-2">
                          ...
                          >
                            <div className="bg-gray-800/90 backdrop-blur-sm rounded-lg p-3 border border-gray-600/50">
                              ...
                              <div className="grid grid-cols-3 gap-2">
                                <Button
                                  size="sm"
                                  className="bg-blue-600 hover:bg-blue-700 text-white p-2 h-auto flex-col"
                                >
                                ...
                                <Button
                                  size="sm"
                                  className="bg-purple-600 hover:bg-purple-700 text-white p-2 h-auto flex-col"
                                >
                                ...
                                <Button
                                  size="sm"
                                  className="bg-green-600 hover:bg-green-700 text-white p-2 h-auto flex-col"
                                >
                        ...
                        >
                          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
                            {achievements.map((achievement, index) => (
                              ...
                              >
                                <Card
                                  className={`p-6 shadow-xl border-0 bg-gradient-to-br ${getRarityColor(
                                    achievement.rarity
