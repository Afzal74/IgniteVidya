...
export default function Grade11Page() {
  ...
  const subjects = [
    { name: "Mathematics", description: "Advanced calculus and algebra", color: "blue" },
    { name: "Physics", description: "Mechanics, thermodynamics, waves", color: "blue" },
    { name: "Chemistry", description: "Organic, inorganic, physical chemistry", color: "green" },
    { name: "Biology", description: "Cell biology, genetics, ecology", color: "emerald" },
    { name: "English", description: "Literature and advanced writing", color: "purple" },
    { name: "Computer Science", description: "Programming and algorithms", color: "indigo" }
  ]
  ...
  const quickAccess = [
    ...
    { title: "Quiz", icon: Target, href: "/quiz?grade=11", description: "Test yourself" },
  ...
  return (
    <GradeAccessGuard requiredGrade={11}>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-sm md:text-lg text-zinc-600 dark:text-zinc-400 mb-4">
              Scientist • Higher Secondary • Master scientific concepts
            </p>
            <div className="flex justify-center gap-2">
              <span className="text-xs px-3 py-1 rounded-full bg-teal-100 text-teal-700 dark:bg-teal-900 dark:text-teal-300">
                6 Subjects
              </span>
