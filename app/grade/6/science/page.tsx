...
export default function Grade6SciencePage() {
  ...
  const scienceChapters = [
    {
      id: 1,
      name: "Food (Sources, Components, Balance of Diet)",
      description: "Learn about food sources, nutrients, and balanced diet",
      icon: Leaf,
      status: "coming-soon",
      href: "#coming-soon",
    },
    {
      id: 2,
      name: "Materials (Sorting, Separating, Changes Around Us)",
      description: "Understanding materials, their properties and changes",
      icon: TestTube,
      status: "coming-soon",
      href: "#coming-soon",
    },
    {
      id: 3,
      name: "The Living Organisms (Habitats, Adaptations, Body Movements)",
      description: "Explore living organisms, their habitats and adaptations",
      icon: Fish,
      status: "coming-soon",
      href: "#coming-soon",
    },
    {
      id: 4,
      name: "Human Body & Health (Organ Systems, Breathing, Digestion)",
      description: "Learn about human body systems and health",
      icon: Heart,
      status: "coming-soon",
      href: "#coming-soon",
    },
    {
      id: 5,
      name: "Motion & Measurement of Distances",
      description: "Understanding motion and measuring distances",
      icon: Activity,
      status: "coming-soon",
      href: "#coming-soon",
    },
    {
      ...
      description: "Explore properties of light and shadow formation",
      icon: Sun,
      status: "coming-soon",
      href: "#coming-soon",
    },
    {
      ...
      description: "Basic concepts of electricity and electric circuits",
      icon: Zap,
      status: "coming-soon",
      href: "#coming-soon",
    },
    {
      id: 8,
      name: "Magnets and Their Effects",
      description: "Understanding magnets and magnetic properties",
      icon: Magnet,
      status: "coming-soon",
      href: "#coming-soon",
    },
    {
      id: 9,
      name: "Water, Air, Garbage in Garbage out",
      description:
        "Environmental science basics - water, air, and waste management",
      icon: Recycle,
      status: "coming-soon",
      href: "#coming-soon",
    },
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-black relative overflow-hidden">
      {/* Global Animated Background Elements - matching Mathematics page */}
      ...
      {/* Animated Background */}
      <div className="absolute inset-0 bg-gradient-to-br from-green-50/30 via-white to-blue-50/30 dark:from-gray-900/50 dark:via-black dark:to-green-900/50" />
      ...
      <div className="absolute inset-0">
        ...
        />
        <motion.div
          className="absolute top-3/4 right-1/4 w-48 h-48 bg-gradient-to-r from-purple-400/25 to-green-400/25 dark:from-purple-400/10 dark:to-green-400/10 rounded-full blur-3xl"
          animate={{
            scale: [1, 1.3, 1],
            x: [0, -40, 0],
            y: [0, 20, 0],
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-8 md:mb-12">
            <div className="mb-4 md:mb-6">
              <div className="w-16 h-16 md:w-20 md:h-20 rounded-xl bg-gradient-to-br from-green-500 to-green-700 dark:from-green-400 dark:to-green-600 flex items-center justify-center mx-auto shadow-lg">
                <Microscope className="text-white h-8 w-8 md:h-10 md:w-10" />
              </div>
            </div>
            <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-black dark:text-white mb-2 relative z-20">
              <span className="block sm:hidden">Science - Class 6</span>
              <span className="hidden sm:block">Science - Class 6</span>
            </h1>
