  ...
  const mathematicsChapters = [
    {
      ...
      description:
        "Learn about large numbers, place value, and number patterns",
      icon: Hash,
      status: "available",
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <Link href="/grade/6">
              <Button
                variant="ghost"
                size="sm"
                className="mb-3 sm:mb-4 md:mb-6 text-black dark:text-white hover:text-zinc-600 dark:hover:text-zinc-300 text-xs sm:text-sm px-2 py-1 sm:px-3 sm:py-2 h-auto relative z-20"
              >
            ...
            <div className="text-center mb-4 sm:mb-6 md:mb-8 lg:mb-12">
              ...
              <h1 className="text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl font-bold text-black dark:text-white mb-1 sm:mb-2 relative z-20">
                <span className="block sm:hidden">Math - Class 6</span>
                <span className="hidden sm:block">Mathematics - Class 6</span>
              </h1>
              <p className="text-xs sm:text-sm md:text-base lg:text-lg text-zinc-600 dark:text-zinc-400 px-2 sm:px-4 relative z-20">
                      ...
                      <Card className="bg-white/90 dark:bg-zinc-800 border-gray-200 dark:border-zinc-700 hover:bg-white dark:hover:bg-zinc-700 transition-all duration-300 cursor-pointer p-4 md:p-6 backdrop-blur-sm">
                        <div className="flex items-start gap-3 md:gap-4">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <Button
                              size="sm"
                              className="bg-blue-600 hover:bg-blue-700 text-white w-full sm:w-auto text-xs md:text-sm"
                            >
