-- CLEAN FUNCTION RESET - Drop all versions and recreate cleanly
...
-- Step 4: Create the ONLY function version we need
...
BEGIN
    ...
    -- BULLETPROOF achievement creation - ALWAYS include achievement_type with conflict handling
...
BEGIN
    ...
    RAISE NOTICE 'CLEAN FUNCTION RESET COMPLETE!';
    RAISE NOTICE 'Function created with signature matching your login page exactly';
    RAISE NOTICE 'All future achievement insertions protected against NULL values';
END $$;